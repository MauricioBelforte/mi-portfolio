...
export async function generarContexto(mensajeDelUsuario) {
    ...
    let perfil = {
        ...
        "profesion": "es Desarrollador Web Full-Stack y ofrece servicios de desarrollo web para empresas",
        "descripcion": "es un desarrollador versátil. Por un lado, crea aplicaciones complejas con Node.js y React para el sector IT. Por otro, ayuda a empresas y negocios a consolidar su presencia digital con sitios web profesionales.",
